...
import handleAboutImg from '../utilities/handleAboutImg.js';
    ...
    <header class="flex dark:bg-neutral-800 border-1 border-neutral-200 dark:border-neutral-600 bg-white justify-between items-center p-1 rounded-[12px] ">
      ...
      <div class="border-1 border-t-0 border-b-0 border-neutral-200 dark:border-neutral-600 mx-2">
        ...
        <article class="mt-[16px] mb-[32px]">
            <h1 class="z-10 mb-[32px] font-black text-[32px] relative before:absolute before:bottom-[20%] before:z-[-10] before:w-[154px] before:h-[6px] before:bg-[#93cffc]">About Me</h1>
            <p class="my-[16px]">Hi, I’m Paulina! Ever since I can remember, I’ve had a passion for creativity and problem-solving. That’s what led me to the world of front-end web development. There’s something magical about seeing an idea come to life in the browser—whether it’s a simple layout experiment or a complex interface for a bigger project.</p>
            <p class="my-[16px]">When I’m not coding, I love getting lost in a good book. My taste is pretty eclectic: I’ll happily read everything from fantasy novels to biographies of tech pioneers. Reading helps me unwind and often sparks new ideas for my coding projects.
</p>
            <p class="my-[16px]">Another big passion of mine is the great outdoors. Hiking allows me to disconnect from the digital world and reconnect with nature. I love challenging hikes with rewarding views at the top. And if I’m not on the trails, you might catch me rock climbing. The combination of mental focus and physical endurance is a perfect parallel to tackling tough coding challenges!</p>
            <p class="my-[16px]">Some of my favorite books:</p>
            ...
            <p class="my-[16px]">I absolutely love my workspace as a place that inspires me to do my best work, so I thought I’d share it with you:</p>
...
const initializeEventsAboutPage = (path) => {
    ...
    handleAboutImg(document.querySelector('.about-img'));
      // Render latest posts
